        ...
        if selected_col:
            with st.expander("Graph Viwer", expanded=True):
                ...
                if 'original_data' in st.session_state:
                    ...
                    # check if 'Coordinates.x', 'Coordinates.y', 'Coordinates.z' columns are present in the dataframe
                    if 'Coordinates.x' in df_full_data_modify.columns and 'Coordinates.y' in df_full_data_modify.columns and 'Coordinates.z' in df_full_data_modify.columns:
                        # Drop the 'Coordinates.x', 'Coordinates.y', 'Coordinates.z' columns
                        desired_order = ['Name', 'light', 'temperature', 'humidity', 'barometric_pressure', 'barometric_temp', 'battery', 'Coordinates.x', 'Coordinates.y', 'Coordinates.z', 'Labels', 'LabelOptions']
                    else:
                        desired_order = ['Name', 'light', 'temperature', 'humidity', 'barometric_pressure', 'barometric_temp', 'battery', 'Labels', 'LabelOptions']
                    try:
                        df_full_data_modify = df_full_data_modify[desired_order]
                    except ValueError:
                        pass 
                    # Move the following columns to the end: Coordinates.x, Coordinates.y, Coordinates.z, Labels, LabelOptions
